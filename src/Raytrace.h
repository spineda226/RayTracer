...
void raytrace(int g_width, int g_height, int x, int y, const BVH_Node &bvh, const std::vector<Shape *> &planes, const Camera &camera, const std::vector<LightSource *> &lights);
